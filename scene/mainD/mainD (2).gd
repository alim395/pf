...
func _ready() -> void:
	$Player/CanvasLayer/HUD/HealthBar.max_value = $Player.maxhealthPoints
	$Player/CanvasLayer/HUD/MagicBar.max_value = $Player.maxmagicPoints
...
func set_health_bar() -> void:
	$Player/CanvasLayer/HUD/HealthBar.value = current_health  # Use interpolated value

func set_magic_bar() -> void:
	$Player/CanvasLayer/HUD/MagicBar.value = $Player.currmagicPoints
